...
try
{
      Class.forName("oracle.jdbc.OracleDriver");
       ...
       System.out.println("2");
		...
		String query;
query="select ac_no,loan_id,status,sanction_amount,delay_balance,emi_amount,emi_day,total_no_emi from loan where ac_no="+ac_no;
...
<tr>
<td>Total no Emi :</td>
<td><input type="text" name="total_no_emi" value="<% out.print(rs.getInt("total_no_emi"));%>" id="total_no_emi"/>
</td>
</tr>
<tr>
<td></td>
